...
CGFloat const FSCalendarStandardTitleTextSize = 9.0;
CGFloat const FSCalendarStandardSubtitleTextSize = 8.0;
CGFloat const FSCalendarStandardWeekdayTextSize = 10.0;
CGFloat const FSCalendarStandardHeaderTextSize = 13.0;
