...
- (instancetype)init
{
    ...
    if (self) {
        ...
        */
        ...
        _titleFont = [UIFont fontWithName:@"Lato-Black" size:FSCalendarStandardTitleTextSize];
        _subtitleFont = [UIFont fontWithName:@"Lato-Black" size:FSCalendarStandardSubtitleTextSize];
        _weekdayFont = [UIFont fontWithName:@"Lato-Black" size:FSCalendarStandardWeekdayTextSize];
        _headerTitleFont = [UIFont fontWithName:@"Lato-Black" size:FSCalendarStandardHeaderTextSize];
