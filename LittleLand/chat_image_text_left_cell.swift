//
//  chat_image_text_left_cell.swift
//  LittleLand
//
...
class chat_image_text_left_cell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        ApiUtillity.sharedInstance.setCornurRadius(obj: self.view_Chat_Message, cornurRadius: 13, isClipToBound: true, borderColor: "DB9182", borderWidth: 1.0)
